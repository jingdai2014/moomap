...
def heatmap():
    ...
    del deskids
    return render_template('heatmap.html', pams={"pam": pams}, rows=c.rows, columns=c.columns, timeGroup=timeGroup, mapTime=mapTime, classId=classId)
